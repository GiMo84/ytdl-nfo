...
def main():
    ...
    parser.add_argument('-e', '--extractor', type=str,help='Specify specific extractor')
    parser.add_argument('--regex', type=str, help='Specify regex search string to match files', default=r".info.json$")
